...
// indicating the music index of which song is playing 1

let musicIndex = Math.floor((Math.random() * allMusic.length ) + 1 );  //.5*6= 3+1 = 4 
...
//  to load the content of the random songs in UI
...
// adding the event listner to all the buttons
...
// make working of previous btn
prevBtn.addEventListener('click', () => {
  prevMusic();
})
// make working of next song  btn
...
progressArea.addEventListener("click", (e) => {
  let progressWidth = progressArea.clientWidth; //getting the total width of progress bar
  let clickedOffsetX = e.offsetX; //getting offset x-axis value
...
// the shuffle button functin by using switch statements
...
// whne the onclick event in any of li tag happened,then the music has to start playing
      allLiTag[j].setAttribute("onclick", "clicked(this)");
  }
}

// when we click on a song in playlist
