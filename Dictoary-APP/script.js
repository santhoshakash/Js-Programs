...
const handle = async (e) => {
    if (e.keyCode == 13) {
        ...
        // make a request to the apid and append the word to path in api
        ...
        if (result.ok) {
            ...
            //this are indexes of ele in api
            ...
            if (synonymsArray.length) {
                //it iterate over entire ele in array
